  ...
  settings = {
        java = {
            jdt = {
                ls = {
                    sources = {
                        "org.eclipse.jdt.ls.java-source", -- Decompilation
                        "org.eclipse.jdt.ls.composite-source",
                    },
                    vmArgs = {
                        -- Java home (adjust based on your system)
                        '-java.home', '/usr/lib/jvm/java-17-openjdk',
                        '-Dosgi.requiredJavaVersion=17', -- Match your JDK version
                        -- If you have src.zip, add its path
                        '-Djdt.ls.java.source.path=/usr/lib/jvm/java-17-openjdk/src.zip',
                        -- Alternatively, use FERUF (decompiler)
            ...
            contentProvider = { preferred = 'neovim' },
            references = { includeDecompilation = true },
        },
    },
}
